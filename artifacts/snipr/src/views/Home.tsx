            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-2 mb-7">
                <a href="#" title="X / Twitter"
                  className="w-8 h-8 rounded-lg bg-[#1A1A22] hover:bg-[#252530] border border-[#2E2E3A] flex items-center justify-center text-[#666] hover:text-[#EFEFF0] transition-all">
